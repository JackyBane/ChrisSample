package com.example.chris.myapplication.api.base;

import com.example.chris.myapplication.App;
import com.example.chris.myapplication.api.base.persistentcookiejar.ClearableCookieJar;
import com.example.chris.myapplication.api.base.persistentcookiejar.PersistentCookieJar;
import com.example.chris.myapplication.api.base.persistentcookiejar.cache.SetCookieCache;
...
//                .addInterceptor(loggingInterceptor)//设置 Debug Log 模式
    ...
    //    //header配置
    Interceptor REWRITE_HEADER_CONTROL_INTERCEPTOR = new LoggingInterceptor() {
        @Override
...
//                .addHeader("Cookie", "add cookies here")
    ...
    //cache配置
    Interceptor REWRITE_CACHE_CONTROL_INTERCEPTOR = new LoggingInterceptor() {
        @Override
